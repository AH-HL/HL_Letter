...
public class BaseMvpProxy<V extends BaseMvpView, P extends BaseMvpPresenter<V>> implements IPresenterProxy<V, P> {
    ...
    public BaseMvpProxy(IPresenterMvpFactory<V, P> IPresenterMvpFactory) {
        this.mFactory = IPresenterMvpFactory;
    }
