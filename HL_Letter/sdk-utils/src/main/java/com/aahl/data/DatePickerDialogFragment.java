 ...
 * @author : Mr.Hao
 * @date :  2018/6/23
 * @description : 时间选择器，弹出框
 */

public class DatePickerDialogFragment extends DialogFragment {

	protected DialogPicker mDatePicker;
		...
		mDecideButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				if (mOnDateChooseListener != null) {
					mOnDateChooseListener.onDateChoose(mDatePicker.getSelectedOne(),
							mDatePicker.getSelectedTwo(), mDatePicker.getSelectedThree());
				}
				dismiss();
			}
		});
	...
	private void setSelectedDate() {
		if (mDatePicker != null) {
//			mDatePicker.setTime(mSelectedYear+"", mSelectedMonth+"", false);
		}
	}

	public interface OnDateChooseListener {
		void onDateChoose(String one, String two, String three);
	}
